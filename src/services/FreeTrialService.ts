...
export const TRIAL_BENEFITS: TrialBenefit[] = [
  {
    ...
    descriptionTr: 'Kesintisiz öğrenme deneyimi',
  },
  {
    id: 'unlimited-lessons',
    emoji: '♾️',
    title: 'Unlimited Lessons',
    titleTr: 'Sınırsız Ders',
    description: 'No daily lesson limit',
    descriptionTr: 'Günlük ders sınırı yok',
  },
  {
    id: 'unlimited-hearts',
    emoji: '❤️',
    title: 'Unlimited Hearts',
    titleTr: 'Sınırsız Can',
    description: 'Never run out of hearts',
    descriptionTr: 'Canların hiç bitmesin',
  },
  {
    id: 'ai-chat',
    emoji: '🤖',
    title: 'AI Chat Assistant',
    titleTr: 'AI Sohbet Asistanı',
    description: 'Personal AI tutor',
    descriptionTr: 'Kişisel AI öğretmen',
  },
  {
    ...
    titleTr: 'Özel İçerik',
    description: 'Premium lessons & stories',
    descriptionTr: 'Premium dersler ve hikayeler',
  },
  {
    id: 'streak-freeze',
    emoji: '🧊',
    title: 'Free Streak Freeze',
    titleTr: 'Ücretsiz Seri Dondurma',
    description: '1 free streak freeze per week',
    descriptionTr: 'Haftada 1 ücretsiz seri dondurma',
  },
];
...
class FreeTrialService {
  ...
  async activatePremium(): Promise<void> {
    ...
    const data = raw
      ? JSON.parse(raw)
      : { trialStartDate: new Date().toISOString(), trialEndDate: new Date().toISOString() };
    data.isPremium = true;
    await AsyncStorage.setItem(STORAGE_KEY, JSON.stringify(data));
  }
