...
class StudyRoomService {
    ...
    async createRoom(userId: string, displayName: string, category: string, topic: string): Promise<StudyRoom> {
    ...
    joinRoom(roomId: string, userId: string, displayName: string, callbacks: {
