...
export const COLOR_BLIND_OPTIONS: ColorBlindOption[] = [
    { id: 'none', label: 'Default', labelTr: 'Varsayılan', description: 'Standard colors', descriptionTr: 'Standart renkler', emoji: '🎨' },
    { id: 'protanopia', label: 'Protanopia', labelTr: 'Protanopi', description: 'Red-green (red weak)', descriptionTr: 'Kırmızı-yeşil (kırmızı zayıf)', emoji: '🔴' },
    { id: 'deuteranopia', label: 'Deuteranopia', labelTr: 'Döteranopi', description: 'Red-green (green weak)', descriptionTr: 'Kırmızı-yeşil (yeşil zayıf)', emoji: '🟢' },
    { id: 'tritanopia', label: 'Tritanopia', labelTr: 'Tritanopi', description: 'Blue-yellow', descriptionTr: 'Mavi-sarı', emoji: '🔵' },
];
...
class AccessibilityService {
    ...
    /** Ayar güncelle */
    async updateSetting<K extends keyof AccessibilitySettings>(key: K, value: AccessibilitySettings[K]): Promise<void> {
