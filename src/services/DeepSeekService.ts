...
class DeepSeekService {
  ...
  private calculateRegeneratedLives(profile: any): number {
    ...
    return Math.min((profile?.current_lives ?? 0) + livesRegenerated, LIVES_CONFIG.maxLives);
  }
...
`;
      ...
      questions: [
        {
          ...
          correctAnswer: 1,
          explanation:
            'Pasifik Okyanusu, dünya yüzeyinin yaklaşık üçte birini kaplar ve en büyük okyanustur.',
          difficulty: 'easy',
          points: 10,
        },
        {
          ...
          correctAnswer: 0,
          explanation: "Evet, Ay Dünya'nın bilinen tek doğal uydusudur.",
          difficulty: 'easy',
          points: 10,
        },
        {
          ...
          correctAnswer: 2,
          explanation: 'Deri, yaklaşık 2 m² yüzey alanıyla vücudun en büyük organıdır.',
          difficulty: 'medium',
          points: 15,
        },
        {
          ...
          correctAnswer: 3,
          explanation:
            'Photoshop bir görüntü düzenleme yazılımıdır, programlama dili değildir. (Not: HTML de tartışmalıdır ama seçeneklerde Photoshop açıkça yazılım.)',
          difficulty: 'medium',
          points: 15,
        },
        {
          ...
          correctAnswer: 0,
          explanation:
            'Işık saniyede ~300.000 km hızla hareket ederken, ses saniyede ~343 m hızla hareket eder.',
          difficulty: 'easy',
          points: 10,
        },
      ],
  ...
  getFallbackLesson(category?: string, difficulty?: string): GeneratedLesson {
    const fallback =
      DeepSeekService.FALLBACK_LESSONS[category || ''] ||
