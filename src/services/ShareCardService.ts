...
export const CARD_TEMPLATES: CardTemplate[] = [
    {
        type: 'streak',
        title: 'Streak Record!', titleTr: 'Seri Rekoru!',
        emoji: '🔥',
        colors: ['#FF6B35', '#F7931E', '#FFB800'],
        generateText: (d) => `🔥 ${d.streak} day streak on Neuralis! Never stop learning!`,
        generateTextTr: (d) => `🔥 Neuralis'te ${d.streak} günlük seri! Öğrenmeye devam! #Neuralis #Learning`,
    },
    {
        type: 'xp-milestone',
        title: 'XP Milestone!', titleTr: 'XP Başarısı!',
        emoji: '⭐',
    ...
    },
    {
        ...
        title: 'League Up!', titleTr: 'Lig Yükselme!',
        emoji: '🏆',
    ...
    {
        type: 'achievement',
        title: 'Achievement Unlocked!', titleTr: 'Başarı Kazanıldı!',
        emoji: '🎖️',
    ...
    {
        type: 'weekly-summary',
        title: 'Weekly Summary', titleTr: 'Haftalık Özet',
        emoji: '📊',
        colors: ['#3498DB', '#2980B9', '#1F618D'],
        generateText: (d) => `📊 This week on Neuralis: ${d.lessons} lessons, ${d.xp} XP, ${d.streak} day streak!`,
        generateTextTr: (d) => `📊 Bu hafta Neuralis'te: ${d.lessons} ders, ${d.xp} XP, ${d.streak} günlük seri! #Neuralis`,
    },
    {
        type: 'duel-win',
        title: 'Duel Victory!', titleTr: 'Düello Zaferi!',
        emoji: '⚔️',
        colors: ['#E74C3C', '#C0392B', '#922B21'],
        generateText: (d) => `⚔️ Won a duel on Neuralis! Score: ${d.myScore}-${d.opponentScore}`,
        generateTextTr: (d) => `⚔️ Neuralis'te düello kazandım! Skor: ${d.myScore}-${d.opponentScore} #Neuralis`,
    },
    {
        type: 'level-up',
        title: 'Level Up!', titleTr: 'Seviye Atladım!',
        emoji: '🆙',
        colors: ['#00B894', '#00CEC9', '#0984E3'],
        generateText: (d) => `🆙 Reached Level ${d.level} on Neuralis! The brain keeps growing!`,
        generateTextTr: (d) => `🆙 Neuralis'te Seviye ${d.level}'e ulaştım! Beyin büyümeye devam! #Neuralis`,
    },
    {
        type: 'tournament-rank',
        title: 'Tournament!', titleTr: 'Turnuva!',
        emoji: '🥇',
