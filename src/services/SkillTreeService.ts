...
const MATH_TREE: Omit<SkillNode, 'status' | 'progress'>[] = [
  ...
  },
  {
    id: 'math_fractions',
    title: 'Kesirler',
    description: 'Kesir işlemleri ve dönüşümler',
    category: 'mathematics',
    icon: '🔢',
    xpRequired: 50,
  ...
  },
  {
    id: 'math_decimals',
    title: 'Ondalıklar',
    description: 'Ondalık sayılar ve yüzdeler',
    category: 'mathematics',
    icon: '📊',
    xpRequired: 50,
    prerequisites: ['math_basics'],
  ...
  },
  {
    id: 'math_algebra1',
    title: 'Cebir I',
    description: 'Denklemler ve eşitsizlikler',
    category: 'mathematics',
    icon: '🔤',
    xpRequired: 100,
    prerequisites: ['math_fractions', 'math_decimals'],
    level: 2,
  ...
  },
  {
    id: 'math_geometry1',
    title: 'Geometri I',
    description: 'Açılar, üçgenler, çokgenler',
    category: 'mathematics',
    icon: '📐',
    xpRequired: 100,
    prerequisites: ['math_basics'],
  ...
  },
  {
    id: 'math_stats',
    title: 'İstatistik',
    description: 'Ortalama, medyan, mod',
    category: 'mathematics',
    icon: '📈',
    xpRequired: 100,
  ...
  },
  {
    id: 'math_algebra2',
    title: 'Cebir II',
    description: 'Polinomlar ve fonksiyonlar',
    category: 'mathematics',
    icon: '📐',
    xpRequired: 200,
    prerequisites: ['math_algebra1'],
    level: 3,
    position: { x: 0.4, y: 0.4 },
    rewards: { xp: 150, badge: 'Algebra Master' },
  },
  {
    id: 'math_geometry2',
    title: 'Geometri II',
    description: 'Daire, hacim, alan',
    category: 'mathematics',
    icon: '🔵',
    xpRequired: 200,
    prerequisites: ['math_geometry1', 'math_algebra1'],
    level: 3,
  ...
  },
  {
    id: 'math_trig',
    title: 'Trigonometri',
    description: 'Sin, cos, tan ve uygulamalar',
    category: 'mathematics',
    icon: '📏',
    xpRequired: 250,
    prerequisites: ['math_algebra2', 'math_geometry2'],
    level: 4,
  ...
  },
  {
    ...
    description: 'Limit, türev, integral',
    category: 'mathematics',
    icon: '∫',
    xpRequired: 300,
    prerequisites: ['math_trig'],
    level: 5,
    position: { x: 0.5, y: 0.05 },
    rewards: { xp: 300, badge: 'Math Champion' },
  },
];
...
const SCIENCE_TREE: Omit<SkillNode, 'status' | 'progress'>[] = [
  ...
  },
  {
    id: 'sci_energy',
    title: 'Enerji',
    description: 'Enerji türleri ve dönüşümler',
    category: 'science',
    icon: '⚡',
    xpRequired: 50,
    prerequisites: ['sci_matter'],
    level: 1,
    position: { x: 0.3, y: 0.75 },
    rewards: { xp: 75 },
  },
  {
    id: 'sci_cells',
    title: 'Hücre',
    description: 'Hücre yapısı ve bölünme',
    category: 'science',
    icon: '🧬',
    xpRequired: 50,
    prerequisites: ['sci_matter'],
  ...
  },
  {
    id: 'sci_chemistry',
    title: 'Kimya',
    description: 'Atom, element, bileşik',
    category: 'science',
    icon: '🧪',
    xpRequired: 100,
    prerequisites: ['sci_matter', 'sci_energy'],
    level: 2,
  ...
  },
  {
    id: 'sci_biology',
    title: 'Biyoloji',
    description: 'Canlılar ve sistemler',
    category: 'science',
    icon: '🌿',
    xpRequired: 100,
    prerequisites: ['sci_cells'],
    level: 2,
  ...
  },
  {
    id: 'sci_waves',
    title: 'Dalgalar',
    description: 'Ses ve ışık dalgaları',
    category: 'science',
    icon: '🌊',
    xpRequired: 200,
    prerequisites: ['sci_forces'],
    level: 3,
  ...
  },
  {
    id: 'sci_organic',
    title: 'Organik Kimya',
    description: 'Karbon bileşikleri',
    category: 'science',
    icon: '💎',
    xpRequired: 250,
    prerequisites: ['sci_chemistry', 'sci_biology'],
    level: 4,
    position: { x: 0.5, y: 0.2 },
    rewards: { xp: 200, badge: 'Science Pro' },
  },
  {
    id: 'sci_quantum',
    title: 'Modern Fizik',
    description: 'Kuantum ve relativite',
    category: 'science',
    icon: '🌌',
    xpRequired: 300,
    prerequisites: ['sci_waves', 'sci_organic'],
    level: 5,
    position: { x: 0.5, y: 0.05 },
    rewards: { xp: 300, badge: 'Science Champion' },
  },
];
