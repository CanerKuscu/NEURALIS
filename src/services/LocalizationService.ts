...
export const SUPPORTED_LOCALES: readonly NotificationLocale[] = ['en', 'tr', 'de', 'es', 'fr'] as const;

// ═══════════════════════════════════════════════════════════════════════════
// NOTIFICATION TRANSLATIONS
// ═══════════════════════════════════════════════════════════════════════════

const NOTIFICATION_STRINGS: Record<NotificationLocale, Record<NotificationSeverity, NotificationTemplate>> = {
    en: {
        normal: {
...
class LocalizationService {
    ...
    async initialize(): Promise<void> {
        ...
        try {
            ...
            console.log(`[LocalizationService] Initialized: locale=${this.currentLocale}, timezone=${this.timezone}`);
        } catch (error) {
