...
import { LeagueTier, LeagueConfig, LeagueBracket, BracketParticipant, UserProfile } from '../types';
...
class RankingService {
    ...
    async updateUserRankPoints(
        ...
        const newAccuracy = (participant.weeklyAccuracy * (totalAttempts - 1) + accuracy) / totalAttempts;
        const newSpeed = participant.weeklySpeed > 0 ? (participant.weeklySpeed + timeTaken) / 2 : timeTaken;
