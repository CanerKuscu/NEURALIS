...
const MOTIVATION_MESSAGES = [
    ...
    { level: 'warning', emoji: '⚠️', message: 'Dikkat! Biraz fazla scroll yapmış olabilirsin. Bir mola ver?' },
    { level: 'warning', emoji: '🧠', message: 'Beynin seni uyarıyor: daha az scroll, daha çok öğren!' },
    { level: 'critical', emoji: '🔥', message: 'Tehlike bölgesi! Ekran süren yüksek. Neuralis\'e dön ve beynini besle!' },
    { level: 'critical', emoji: '💀', message: 'Beyin çürümesi riski! Her dakika öğrenmek için bir fırsat. Şimdi başla!' },
    { level: 'critical', emoji: '🚨', message: 'Acil durum! Potansiyelini scrolling\'e harcama. Büyüklük seni bekliyor!' },
];
...
class DopamineMonitorService {
     ...
     */
    async selfReportUsage(appName: string, minutes: number): Promise<{
        message: string;
        emoji: string;
        level: 'good' | 'warning' | 'critical';
