...
const TOURNAMENT_TEMPLATES: Omit<Tournament, 'id' | 'startsAt' | 'endsAt'>[] = [
  {
    title: 'Speed Blitz',
    titleTr: 'Hız Fırtınası',
    description: 'Answer as fast as you can!',
    descriptionTr: 'Olabildiğince hızlı cevapla!',
    emoji: '⚡',
    theme: 'speed',
    entryFee: 50,
    questionCount: 20,
  ...
  {
    title: 'Perfect Score',
    titleTr: 'Mükemmel Skor',
    description: 'Accuracy matters most',
    descriptionTr: 'Doğruluk her şeyden önemli',
    emoji: '🎯',
    theme: 'accuracy',
    entryFee: 30,
    questionCount: 15,
  ...
  {
    title: 'Survival Mode',
    titleTr: 'Hayatta Kalma',
    description: "One wrong answer and you're out!",
    descriptionTr: 'Bir yanlış cevap ve elenirsin!',
    emoji: '💀',
    theme: 'survival',
    entryFee: 100,
    questionCount: 30,
  ...
  },
  {
    title: 'Streak Master',
    titleTr: 'Seri Ustası',
    description: 'Build the longest correct streak',
    descriptionTr: 'En uzun doğru cevap serisini kur',
    emoji: '🔥',
    theme: 'streak',
    entryFee: 40,
    questionCount: 25,
