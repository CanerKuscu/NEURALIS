...
export const AchievementService = {
     ...
     */
    updateProgress: async (userId: string, achievementId: string, currentProgress: number, target: number) => {
     ...
     */
    incrementProgress: async (userId: string, achievementId: string, amount: number = 1, target: number) => {
        // Fetch current
