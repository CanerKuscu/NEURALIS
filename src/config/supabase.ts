...
try {
    ...
    if (__DEV__) console.warn('[Supabase] expo-secure-store not available, falling back to AsyncStorage');
}
...
const supabaseAnonKey = expoExtra.SUPABASE_ANON_KEY || process.env.EXPO_PUBLIC_SUPABASE_ANON_KEY || '';
