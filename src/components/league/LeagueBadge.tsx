...
import Svg, { Path, Defs, LinearGradient, RadialGradient, Stop, G, Circle, Ellipse, Polygon, Rect } from 'react-native-svg';

export type LeagueRank = 'bronze' | 'silver' | 'gold' | 'platinum' | 'diamond' | 'master' | 'grandmaster' | 'challenger';
...
const RANK_COLORS: Record<LeagueRank, { primary: string; secondary: string; accent: string; glow: string }> = {
            ...
            case 'bronze':
                return (
                    <G>
                        ...
                        <Path d="M50,35 L55,45 L65,47 L57,55 L60,65 L50,60 L40,65 L43,55 L35,47 L45,45 Z" fill={colors.accent} />
                    </G>
                );
            ...
            case 'silver':
                return (
                    <G>
                        ...
                        <Path d="M50,30 L56,42 L70,44 L60,54 L63,68 L50,61 L37,68 L40,54 L30,44 L44,42 Z" fill="#FFF" opacity={0.8} />
                    </G>
                );
            ...
            case 'gold':
                return (
                    <G>
                        ...
                        <Path d="M50,40 L56,50 L67,52 L59,60 L61,72 L50,66 L39,72 L41,60 L33,52 L44,50 Z" fill="#FFF" opacity={0.9} />
                    </G>
                );
            ...
            case 'platinum':
                return (
                    <G>
                        ...
                        />
                        {/* Hexagon pattern */}
                        <Polygon points="50,25 70,38 70,62 50,75 30,62 30,38" fill="none" stroke={colors.accent} strokeWidth="3" />
                        <Circle cx="50" cy="50" r="15" fill={colors.accent} opacity={0.6} />
                        <Path d="M50,38 L55,47 L65,48 L58,55 L60,65 L50,60 L40,65 L42,55 L35,48 L45,47 Z" fill="#FFF" />
                    </G>
                );
            ...
            case 'diamond':
                return (
                    <G>
                        ...
                        />
                        {/* Diamond crystal */}
                        <Polygon points="50,20 70,35 70,60 50,78 30,60 30,35" fill={colors.accent} stroke="#FFF" strokeWidth="2" />
                        <Polygon points="50,20 60,32 50,45 40,32" fill="#FFF" opacity={0.7} />
                        <Path d="M35,42 L50,55 L65,42" stroke="#FFF" strokeWidth="2" fill="none" opacity={0.5} />
                    </G>
                );
            ...
            case 'master':
                return (
                    <G>
                        ...
                        <Circle cx="50" cy="50" r="45" fill="url(#masterGrad)" stroke={colors.secondary} strokeWidth="5" />
                        {/* Inner rings */}
                        ...
                        {/* Star */}
                        <Path d="M50,25 L55,40 L72,42 L60,52 L64,70 L50,60 L36,70 L40,52 L28,42 L45,40 Z" fill={colors.accent} stroke="#FFF" strokeWidth="1" />
                    </G>
                );
            ...
            case 'grandmaster':
                return (
                    <G>
                        ...
                        <Path d="M50,45 L54,55 L65,56 L57,63 L59,74 L50,68 L41,74 L43,63 L35,56 L46,55 Z" fill="#FFD700" />
                    </G>
                );
            ...
            case 'challenger':
                return (
                    <G>
                        ...
                        {/* Inner design */}
                        <Circle cx="50" cy="50" r="32" fill="none" stroke="#FFF" strokeWidth="2" opacity={0.8} />
                        <Circle cx="50" cy="50" r="22" fill="#FFF" opacity={0.3} />
                        {/* Crown */}
                        <Path d="M32,35 L38,48 L50,38 L62,48 L68,35 L65,52 L35,52 Z" fill="#FFD700" stroke="#FFF" strokeWidth="1" />
                        {/* Star */}
                        <Path d="M50,52 L54,62 L65,63 L57,70 L59,80 L50,74 L41,80 L43,70 L35,63 L46,62 Z" fill="#FFF" />
                    </G>
                );
        }
    };
...
export const RANK_ORDER: LeagueRank[] = ['bronze', 'silver', 'gold', 'platinum', 'diamond', 'master', 'grandmaster', 'challenger'];
