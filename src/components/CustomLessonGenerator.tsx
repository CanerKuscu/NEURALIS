...
import { topicStreakService, TopicStreak } from '../services/TopicStreakService';
        ...
        try {
            ...
            if (!lessonData) {
                lessonData = {
                    ...
                    questions: [
                        { question: `What is ${userTopic}?`, options: ['Basic concept', 'Irrelevant', 'Myth', 'None'], correctAnswer: 'Basic concept' },
                        { question: 'Which method is effective?', options: ['Active recall', 'Passive', 'Guessing', 'None'], correctAnswer: 'Active recall' },
                    ],
                };
            }
                        ...
                        {userTopics.map((topicStreak) => (
                            ...
                            >
                                <View style={styles.topicHeader}>
                                    <Text style={styles.topicName} numberOfLines={2}>{topicStreak.topic}</Text>
