...
export function DuoButton({
    ...
    return (
        <TouchableOpacity testID={testID} activeOpacity={0.85} onPress={onPress} disabled={isDisabled} style={base}>
            {loading ? <ActivityIndicator size="small" color={variant === 'primary' ? '#fff' : DUO_COLORS.textPrimary} /> : null}
