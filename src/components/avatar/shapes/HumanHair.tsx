...
export type HairStyle = 'none' | 'short' | 'medium' | 'long' | 'curly' | 'spiky' | 'ponytail' | 'bun' | 'buzz' | 'afro' | 'wavy';
            ...
            case 'medium':
                ...
                return (
                    <G>
                        ...
                        />
                        {/* Side strands */}
                        <Path d="M48,80 Q45,95 50,105" stroke={color} strokeWidth="6" strokeLinecap="round" fill="none" />
                        <Path d="M152,80 Q155,95 150,105" stroke={color} strokeWidth="6" strokeLinecap="round" fill="none" />
                    </G>
                );
            ...
            case 'long':
                ...
                return (
                    <G>
                        ...
                        />
                        {/* Hair strand details */}
                        <Path d="M55,110 Q52,140 58,170" stroke={darkerColor} strokeWidth="1.5" fill="none" opacity={0.3} />
                        <Path d="M145,110 Q148,140 142,170" stroke={darkerColor} strokeWidth="1.5" fill="none" opacity={0.3} />
                    </G>
                );
            ...
            case 'spiky':
                ...
                return (
                    <G>
                        ...
                        <Path d="M100,10 L100,32" stroke={lighterColor} strokeWidth="2.5" strokeLinecap="round" />
                        <Path d="M118,18 L115,38" stroke={lighterColor} strokeWidth="2.5" strokeLinecap="round" />
                    </G>
                );
            ...
            case 'ponytail':
                ...
                return (
                    <G>
                        ...
                        <Path
                            d="M92,32 Q88,5 100,-8 Q112,5 108,32"
                            fill={color}
                        />
            ...
            case 'wavy':
                ...
                return (
                    <G>
                        ...
                        <Path d="M52,85 Q58,100 52,118" stroke={color} strokeWidth="2.5" fill="none" opacity={0.35} />
                        <Path d="M148,85 Q142,100 148,118" stroke={color} strokeWidth="2.5" fill="none" opacity={0.35} />
                    </G>
                );
