...
export const AvatarGlasses: React.FC<GlassesProps> = ({ variant }) => {
    ...
    const glassesStyles: Record<string, React.ReactElement | null> = {
        ...
        square: (
            <G>
                {/* Square glasses */}
                <Rect x="45" y="68" width="40" height="30" rx="4" stroke="#333" strokeWidth="3" fill="none" />
                <Rect x="115" y="68" width="40" height="30" rx="4" stroke="#333" strokeWidth="3" fill="none" />
                {/* Bridge */}
        ...
        sunglasses: (
            <G>
                ...
                <Path d="M42 70 Q45 62, 65 62 Q85 62, 88 70 Q88 95, 65 98 Q42 95, 42 70"
                    fill="#222" stroke="#111" strokeWidth="2" />
                <Path d="M112 70 Q115 62, 135 62 Q155 62, 158 70 Q158 95, 135 98 Q112 95, 112 70"
                    fill="#222" stroke="#111" strokeWidth="2" />
                {/* Bridge */}
                ...
                <Path d="M120 75 Q125 72, 130 75" stroke="rgba(255,255,255,0.3)" strokeWidth="2" fill="none" />
            </G>
        ),
    };
