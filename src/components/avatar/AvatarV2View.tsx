...
import type { AvatarV2Config } from '../../types/avatar-v2';
import { DEFAULT_AVATAR_V2 } from '../../types/avatar-v2';
  ...
  return (
    <View style={[styles.container, { width: size, height: size }]}>
      <Svg width={size} height={size} viewBox={`0 0 ${vb} ${vb}`}>
        ...
        {/* ═══ HEADWEAR ═══ */}
        {c.headwear !== 'none' && <RenderHeadwear type={c.headwear} color={c.headwearColor} />}
      </Svg>
    </View>
  );
}
...
function RenderEye({
  ...
  const eyelashLen =
    eyelashes === 'dramatic' ? 5 : eyelashes === 'long' ? 3.5 : eyelashes === 'natural' ? 2 : 0;
...
function RenderEyebrows({ shape, color }: { shape: string; color: string }) {
  ...
  switch (shape) {
    case 'arched':
      lPath = 'M60,85 Q75,74 90,83';
      rPath = 'M110,83 Q125,74 140,85';
      break;
    case 'straight':
      lPath = 'M60,82 L90,82';
      rPath = 'M110,82 L140,82';
      sw = 2.8;
      break;
    case 'thick':
      sw = 4;
    ...
    case 'thin':
      ...
      break;
    case 'curved':
      lPath = 'M60,85 Q75,76 90,82';
      rPath = 'M110,82 Q125,76 140,85';
      break;
    case 'angeled':
      lPath = 'M60,86 L75,79 L90,82';
      rPath = 'M110,82 L125,79 L140,86';
      break;
    case 'bushy':
      sw = 4.5;
      lPath = 'M58,84 Q75,76 92,84';
      rPath = 'M108,84 Q125,76 142,84';
      break;
  }
  ...
  switch (type) {
    ...
    case 'wide':
      return (
        <G>
          <Path
            d="M95,106 L93,118 Q100,122 107,118 L105,106"
            stroke={skinDark}
            strokeWidth="1.2"
            fill="none"
          />
    ...
    case 'aquiline':
      return (
        <Path
          d="M100,98 L102,108 L100,118 Q96,120 100,118"
          stroke={skinDark}
          strokeWidth="1.5"
          fill="none"
        />
    ...
    case 'snub':
      return (
        <Path
          d="M98,106 Q100,112 100,114 Q102,116 104,114"
          stroke={skinDark}
          strokeWidth="1.3"
          fill="none"
        />
    ...
    default:
      return (
        <G>
          <Path
            d="M100,104 L97,118 Q100,120 103,118 Z"
            stroke={skinDark}
            strokeWidth="1"
            fill="none"
          />
...
function RenderMouth({
  ...
  return (
    <G>
      {showTeeth && <Path d={mouthPath} fill="#FFFFFF" />}
      <Path
        d={mouthPath}
        stroke={fill}
        ...
        opacity={
          showTeeth
            ? 1
            : expression === 'neutral' || expression === 'slight-smile' || expression === 'smirk'
              ? 1
              : 0.85
        }
        strokeLinecap="round"
...
function RenderHair({
  ...
  const hairPaths: Record<string, React.ReactNode> = {
    buzz: (
      <G>
        <Path
          d="M52,85 Q52,42 100,40 Q148,42 148,85 L148,70 Q148,42 100,38 Q52,42 52,70 Z"
          fill={color}
        />
      </G>
    ),
    crew: (
      <G>
        <Path
          d="M50,90 Q48,42 100,38 Q152,42 150,90 L148,75 Q148,44 100,40 Q52,44 52,75 Z"
          fill={color}
        />
    ...
    'short-classic': (
      <G>
        <Path
          d="M48,95 Q46,42 100,36 Q154,42 152,95 L150,80 Q150,44 100,38 Q50,44 50,80 Z"
          fill={color}
        />
    ...
    'short-textured': (
      <G>
        <Path
          d="M48,95 Q44,38 100,34 Q156,38 152,95 L150,78 Q152,40 100,36 Q48,40 50,78 Z"
          fill={color}
        />
        {/* Texture lines */}
    ...
    'side-part': (
      <G>
        <Path
          d="M46,95 Q44,40 100,34 Q156,40 154,95 L150,78 Q152,42 100,36 Q48,42 50,78 Z"
          fill={color}
        />
    ...
    'medium-wavy': (
      <G>
        <Path
          d="M42,105 Q38,38 100,30 Q162,38 158,105 C155,85 152,40 100,34 C48,40 45,85 42,105 Z"
          fill={color}
        />
        {/* Wave texture */}
        <Path
          d="M48,75 Q55,65 48,55 Q55,45 60,42"
          stroke={light}
          strokeWidth="2"
          fill="none"
          opacity={0.3}
        />
        <Path
          d="M152,75 Q145,65 152,55 Q145,45 140,42"
          stroke={light}
          strokeWidth="2"
          fill="none"
          opacity={0.3}
    ...
    'medium-straight': (
      <G>
        <Path
          d="M42,110 Q38,38 100,30 Q162,38 158,110 L155,80 Q155,40 100,34 Q45,40 45,80 Z"
          fill={color}
        />
    ...
    'medium-curly': (
      <G>
        <Path
          d="M40,110 Q35,35 100,28 Q165,35 160,110 C158,80 155,38 100,32 C45,38 42,80 40,110 Z"
          fill={color}
        />
        {/* Curl texture */}
        <Path
          d="M45,75 C42,65 50,55 45,48"
          stroke={light}
          strokeWidth="2.5"
          fill="none"
          opacity={0.3}
        />
        <Path
          d="M155,75 C158,65 150,55 155,48"
          stroke={light}
          strokeWidth="2.5"
          fill="none"
          opacity={0.3}
    ...
    'long-straight': (
      <G>
        <Path
          d="M40,160 Q35,35 100,26 Q165,35 160,160 L158,80 Q160,38 100,30 Q40,38 42,80 Z"
          fill={color}
        />
    ...
    'long-wavy': (
      <G>
        <Path
          d="M38,160 Q32,32 100,24 Q168,32 162,160 C160,80 158,36 100,28 C42,36 40,80 38,160 Z"
          fill={color}
        />
        ...
        {/* Wave texture */}
        <Path
          d="M42,90 Q50,80 42,70 Q50,60 44,50"
          stroke={light}
          strokeWidth="2"
          fill="none"
          opacity={0.3}
        />
        <Path
          d="M158,90 Q150,80 158,70 Q150,60 156,50"
          stroke={light}
          strokeWidth="2"
          fill="none"
          opacity={0.3}
    ...
    'long-curly': (
      <G>
        <Path
          d="M36,158 Q28,28 100,22 Q172,28 164,158 C162,80 160,32 100,26 C40,32 38,80 36,158 Z"
          fill={color}
        />
        {/* Big curls */}
    ...
    'bun-high': (
      <G>
        <Path
          d="M48,92 Q46,42 100,36 Q154,42 152,92 L150,75 Q150,44 100,38 Q50,44 50,75 Z"
          fill={color}
        />
    ...
    'bun-messy': (
      <G>
        <Path
          d="M48,95 Q44,40 100,34 Q156,40 152,95 L150,78 Q152,42 100,36 Q48,42 50,78 Z"
          fill={color}
        />
    ...
    ponytail: (
      <G>
        ...
        />
        <Path
          d="M90,50 Q95,55 100,58 Q105,55 110,50 L115,60 Q110,100 100,130 Q90,100 85,60 Z"
          fill={color}
        />
      </G>
    ),
    ...
    pixie: (
      <G>
        <Path
          d="M48,88 Q46,42 100,36 Q154,42 152,88 L150,72 Q150,44 100,38 Q50,44 50,72 Z"
          fill={color}
        />
        {/* Wispy side */}
    ...
    bob: (
      <G>
        <Path
          d="M44,120 Q40,38 100,32 Q160,38 156,120 L154,78 Q155,42 100,35 Q45,42 46,78 Z"
          fill={color}
        />
    ...
    lob: (
      <G>
        <Path
          d="M42,140 Q38,36 100,30 Q162,36 158,140 L155,78 Q158,40 100,33 Q42,40 45,78 Z"
          fill={color}
        />
    ...
    mohawk: (
      <G>
        <Path
          d="M80,85 Q78,20 100,12 Q122,20 120,85 L118,55 Q118,22 100,16 Q82,22 82,55 Z"
          fill={color}
        />
        {/* Fade sides */}
    ...
    undercut: (
      <G>
        <Path
          d="M50,85 Q48,42 100,36 Q152,42 150,85 L148,72 Q148,44 100,38 Q52,44 52,72 Z"
          fill={color}
        />
        {/* Longer top swept */}
    ...
    fade: (
      <G>
        <Path
          d="M50,90 Q48,42 100,36 Q152,42 150,90 L148,70 Q148,44 100,38 Q52,44 52,70 Z"
          fill={color}
        />
    ...
    'afro-puff': (
      <G>
        <Path
          d="M48,90 Q46,42 100,36 Q154,42 152,90 L150,72 Q150,44 100,38 Q50,44 50,72 Z"
          fill={color}
        />
        {/* Two puffs */}
    ...
    braids: (
      <G>
        <Path
          d="M46,90 Q44,42 100,36 Q156,42 154,90 L152,72 Q152,44 100,38 Q48,44 48,72 Z"
          fill={color}
        />
        {/* Left braid */}
        <Path
          d="M50,90 Q46,105 48,120 Q46,135 50,150 Q48,160 52,170"
          stroke={color}
          strokeWidth="6"
          fill="none"
          strokeLinecap="round"
        ...
        {/* Right braid */}
        <Path
          d="M150,90 Q154,105 152,120 Q154,135 150,150 Q152,160 148,170"
          stroke={color}
          strokeWidth="6"
          fill="none"
          strokeLinecap="round"
    ...
    cornrows: (
      <G>
        <Path
          d="M50,90 Q48,42 100,36 Q152,42 150,90 L148,72 Q148,44 100,38 Q52,44 52,72 Z"
          fill={color}
        />
        {/* Cornrow lines */}
    ...
    dreadlocks: (
      <G>
        <Path
          d="M38,100 Q32,30 100,22 Q168,30 162,100 C160,65 158,34 100,26 C42,34 40,65 38,100 Z"
          fill={color}
        />
        {/* Dread strands */}
        <Path
          d="M42,100 Q38,130 45,160"
          stroke={color}
          strokeWidth="5"
          fill="none"
          strokeLinecap="round"
...
function RenderFacialHair({ type, color }: { type: string; color: string }) {
  ...
  switch (type) {
    ...
    case 'mustache':
      return (
        <Path
          d="M85,128 Q90,134 100,132 Q110,134 115,128"
          stroke={color}
          strokeWidth="3"
          fill="none"
          strokeLinecap="round"
    ...
    case 'chinstrap':
      return (
        <Path
          d="M55,115 Q55,155 100,162 Q145,155 145,115"
          stroke={color}
          strokeWidth="4"
          fill="none"
        />
  ...
  switch (style) {
    ...
    case 'sunglasses-aviator':
      return (
        <G opacity={lensOpacity}>
          <Path
            d="M58,90 Q58,84 75,84 Q92,84 92,90 L92,105 Q92,112 75,112 Q58,112 58,105 Z"
            fill={lensFill}
            stroke={color}
            strokeWidth="2"
          />
          <Path
            d="M108,90 Q108,84 125,84 Q142,84 142,90 L142,105 Q142,112 125,112 Q108,112 108,105 Z"
            fill={lensFill}
            stroke={color}
            strokeWidth="2"
          />
    ...
    case 'cat-eye':
      return (
        <G>
          <Path
            d="M58,100 Q58,86 75,86 Q92,86 92,94 L92,102 Q92,110 75,110 Q58,110 58,102 Z"
            fill={lensFill}
            stroke={color}
            strokeWidth="2"
          />
          <Path
            d="M108,100 Q108,86 125,86 Q142,86 142,94 L142,102 Q142,110 125,110 Q108,110 108,102 Z"
            fill={lensFill}
            stroke={color}
            strokeWidth="2"
          />
    ...
    case 'sunglasses-sport':
      return (
        <G opacity={0.8}>
          <Path
            d="M48,96 Q48,84 75,84 Q100,84 100,92 L100,102 Q100,110 75,110 Q48,110 48,102 Z"
            fill={color}
            stroke={color}
            strokeWidth="1.5"
          />
          <Path
            d="M100,96 Q100,84 125,84 Q152,84 152,92 L152,102 Q152,110 125,110 Q100,110 100,102 Z"
            fill={color}
            stroke={color}
            strokeWidth="1.5"
          />
  ...
  switch (type) {
    case 'cap':
      return (
        <G>
          <Path
            d="M45,72 Q45,30 100,26 Q155,30 155,72 L155,68 Q155,32 100,28 Q45,32 45,68 Z"
            fill={color}
          />
    ...
    case 'beanie':
      return (
        <G>
          <Path
            d="M46,80 Q44,28 100,20 Q156,28 154,80 L154,72 Q154,30 100,24 Q46,30 46,72 Z"
            fill={color}
          />
          {/* Fold line */}
    ...
    case 'bandana':
      return (
        <G>
          <Path
            d="M50,68 Q50,52 100,48 Q150,52 150,68 L148,62 Q148,54 100,50 Q52,54 52,62 Z"
            fill={color}
          />
          {/* Knot at back */}
    ...
    case 'headband':
      return (
        <G>
          <Path
            d="M48,72 Q48,66 100,62 Q152,66 152,72 L150,68 Q150,64 100,60 Q50,64 50,68 Z"
            fill={color}
          />
        </G>
      );
    case 'crown':
      return (
        <G>
          ...
          <Path
            d="M55,65 L60,32 L80,52 L100,28 L120,52 L140,32 L145,65 Z"
            fill="none"
            stroke="#DAA520"
            strokeWidth="1.5"
          />
    ...
    case 'hijab':
      return (
        <G>
          <Path
            d="M42,170 Q38,55 100,30 Q162,55 158,170 L156,80 Q158,45 100,34 Q42,45 44,80 Z"
            fill={color}
          />
          {/* Inner edge */}
          <Path
            d="M52,78 Q52,50 100,40 Q148,50 148,78"
            stroke={dark}
            strokeWidth="1"
            fill="none"
            opacity={0.3}
  ...
  switch (top) {
    case 'hoodie':
      return (
        <G>
          <Path
            d="M55,170 Q40,172 30,200 L170,200 Q160,172 145,170 Q140,168 120,167 L100,165 L80,167 Q60,168 55,170 Z"
            fill={color}
          />
          {/* Hood */}
          <Path
            d="M60,165 Q58,158 65,155 Q80,150 100,150 Q120,150 135,155 Q142,158 140,165"
            fill={color}
          />
          <Path
            d="M60,165 Q58,158 65,155 Q80,150 100,150 Q120,150 135,155 Q142,158 140,165"
    ...
    case 'sweater':
      return (
        <G>
          <Path
            d="M55,170 Q40,172 30,200 L170,200 Q160,172 145,170 Q135,168 118,166 L100,165 L82,166 Q65,168 55,170 Z"
            fill={color}
          />
          {/* Collar */}
    ...
    case 'tank':
      return (
        <G>
          <Path
            d="M68,168 Q55,172 45,200 L155,200 Q145,172 132,168 L120,166 L100,165 L80,166 Z"
            fill={color}
          />
          {/* Straps */}
    ...
    case 'shirt-collar':
      return (
        <G>
          ...
          {/* Collar */}
          <Path
            d="M80,165 L88,155 L100,162 L112,155 L120,165"
            fill="#FFFFFF"
            stroke={dark}
            strokeWidth="0.8"
          />
    ...
    case 'crop-top':
      return (
        <G>
          <Path
            d="M60,168 Q50,172 45,195 L155,195 Q150,172 140,168 Q130,166 118,165 L100,164 L82,165 Q70,166 60,168 Z"
            fill={color}
          />
    ...
    case 'blazer':
      return (
        <G>
          <Path
            d="M50,170 Q35,172 25,200 L175,200 Q165,172 150,170 Q140,168 120,166 L100,165 L80,166 Q60,168 50,170 Z"
            fill={color}
          />
          {/* Lapels */}
    ...
    case 'vest':
      return (
        <G>
          <Path
            d="M65,168 Q55,172 48,200 L152,200 Q145,172 135,168 Q125,166 118,165 L100,164 L82,165 Q75,166 65,168 Z"
            fill={color}
          />
          {/* Armholes */}
          <Path
            d="M65,168 Q60,175 58,185"
            stroke={dark}
            strokeWidth="1"
            fill="none"
            opacity={0.3}
    ...
    case 'dress':
      return (
        <G>
          <Path
            d="M60,168 Q45,172 30,200 L170,200 Q155,172 140,168 Q130,166 118,165 L100,164 L82,165 Q70,166 60,168 Z"
            fill={color}
          />
          {/* Neckline */}
    ...
    case 'overalls':
      return (
        <G>
          {/* Inner shirt */}
          <Path
            d="M60,168 Q50,172 42,200 L158,200 Q150,172 140,168 L118,165 L100,164 L82,165 Z"
            fill="#FFFFFF"
          />
          {/* Overall body */}
          <Path
            d="M65,180 Q55,182 45,200 L155,200 Q145,182 135,180 L120,178 L100,177 L80,178 Z"
            fill={color}
          />
          {/* Straps */}
