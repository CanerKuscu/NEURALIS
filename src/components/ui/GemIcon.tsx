        ...
        <View style={[{ width: size, height: size }, style]}>
            <Svg width="100%" height="100%" viewBox="0 0 100 100">
                ...
                <G>
                    {/* Top facet */}
                    <Polygon
                        points="50,10 80,30 50,40 20,30"
                        fill={`url(#gemGrad_${color})`}
                    />
                    {/* Left facet */}
                    <Polygon
                        points="20,30 50,40 50,85 15,50"
                        fill={`url(#gemDark_${color})`}
                    />
                    {/* Right facet */}
                    <Polygon
                        points="80,30 85,50 50,85 50,40"
                        fill={colors.secondary}
                    />
                    {/* Bottom point */}
                    <Polygon
                        points="50,85 15,50 50,55"
                        fill={colors.dark}
                    />
                    <Polygon
                        points="50,85 85,50 50,55"
                        fill={colors.secondary}
                    />
                    {/* Center highlight */}
                    <Polygon
                        points="50,40 65,45 50,55 35,45"
                        fill={colors.accent}
                        opacity={0.7}
                    />
                </G>
                ...
                {/* Shine effect */}
                <Path
                    d="M30,25 Q40,18 55,25 Q45,22 35,28 Z"
                    fill="#FFFFFF"
                    opacity={0.6}
                />
                <Ellipse
