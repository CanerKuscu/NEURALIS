...
export const StreakTimer: React.FC<StreakTimerProps> = ({
  ...
  return (
    ...
    >
      ...
      <LinearGradient colors={[getStateColors.secondary, COLORS.pureBlack]} style={styles.gradient}>
        {/* Header */}
        ...
        <View style={styles.timerContainer}>
          <View style={styles.timeBlock}>
            <Text style={[styles.timeValue, { color: getStateColors.text }]}>{hours}</Text>
            <Text style={styles.timeLabel}>HRS</Text>
          </View>

          <Text style={[styles.timeSeparator, { color: getStateColors.text }]}>:</Text>

          <View style={styles.timeBlock}>
            <Text style={[styles.timeValue, { color: getStateColors.text }]}>{minutes}</Text>
          ...
          <View style={styles.timeBlock}>
            <Text style={[styles.timeValue, { color: getStateColors.text }]}>{seconds}</Text>
        ...
        <View style={styles.stateIndicator}>
          <View style={[styles.stateDot, { backgroundColor: getStateColors.primary }]} />
