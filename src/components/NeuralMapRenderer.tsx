...
export const NeuralMapRenderer: React.FC<{ currentLevel: number; streakDecay: number }> = React.memo(({ currentLevel, streakDecay }) => {
    ...
    return (
        ...
        >
            <Svg height={MAP_HEIGHT} width={MAP_WIDTH}>
                <Path d="M60,100 Q160,200 60,300 Q160,400 60,500" stroke="#fff" strokeWidth="6" fill="none" />
                {visibleNodes}
            </Svg>
        </ScrollView>
    );
