...
const BLOCKED_KEYWORDS = [
    'attack', 'hack', 'password', 'thief', 'illegal', 'weapon', 'bomb', 'drug',
    'crack', 'steal', 'terror', 'porn'
];
...
export function CustomTopicInput({ onSubmit, onCancel, isPremium }: CustomTopicInputProps) {
            ...
            <View style={styles.container}>
                <View style={styles.lockedContainer}>
                    ...
                    <Text style={styles.lockedText}>
                        Custom topic selection is for Premium members only.
                        Create AI lesson series on your own interests!
                    </Text>
            ...
            <View style={styles.container}>
                <View style={styles.approvedContainer}>
                    ...
                    <Text style={styles.approvedText}>
                        Preparing lesson series on "{topic}"...
                    </Text>
                </View>
            </View>
        );
    ...
    return (
        <View style={styles.container}>
            ...
            >
                <LinearGradient
                    colors={topic.trim() ? [COLORS.primary, '#45B602'] : [COLORS.text.muted, COLORS.text.muted]}
            ...
            <Text style={styles.infoText}>
                AI will analyze your topic and create a personalized lesson series.
                Inappropriate topics may be rejected.
            </Text>
        </View>
    );
}
