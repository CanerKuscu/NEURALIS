      ...
      >
        ...
        <View style={styles.connectionContainer}>
          ...
          <View style={styles.connectionLine}>
            <View style={[styles.linePulse, { backgroundColor: getStatusColor() }]} />
            <View style={styles.lineContainer}>
              <View style={[styles.line, { backgroundColor: getStatusColor() }]} />
            </View>
          ...
          <View style={styles.userCard}>
            <View style={styles.avatarContainer}>
              ...
              {isPartnerActive && <View style={styles.activeIndicator} />}
            </View>
        ...
        {link.status === 'active' && onDissolve && (
          <TouchableOpacity style={styles.dissolveButton} onPress={onDissolve}>
...
export const NoSynapseLink: React.FC<NoSynapseLinkProps> = ({ onCreateLink, style }) => {
  return (
    <TouchableOpacity
      ...
      activeOpacity={0.8}
    >
      <LinearGradient colors={[COLORS.gray[900], COLORS.pureBlack]} style={styles.noLinkGradient}>
