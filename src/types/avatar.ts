...
export const SKIN_COLORS = [
    '#FDEBD0', '#F5D0C5', '#E5B299', '#D4A574', '#C49A6C', '#A67B5B', '#8B6914', '#704214', '#5C4033'
];

export const HAIR_COLORS = [
    '#1A1A1A', '#4A3728', '#8B4513', '#D2691E', '#FFD700', '#DC143C', '#FF69B4', '#4B0082'
];

export const EYE_COLORS = [
    '#4A3728', '#1A1A1A', '#2E8B57', '#4169E1', '#808080'
];

export const SHIRT_COLORS = [
    '#3498DB', '#2ECC71', '#E74C3C', '#9B59B6', '#F39C12', '#1ABC9C', '#34495E', '#E91E63'
];

export const BG_COLORS = [
    '#1A1A2E', '#16213E', '#2C3E50', '#1ABC9C', '#9B59B6', '#E74C3C', '#F39C12', '#2ECC71'
];

export const GLASSES_COLORS = [
    '#1A1A1A', '#4A3728', '#3498DB', '#E74C3C', '#F1C40F', '#9B59B6'
];

export const HAT_COLORS = [
    '#1A1A1A', '#E74C3C', '#3498DB', '#2ECC71', '#F39C12', '#9B59B6', '#34495E'
];
