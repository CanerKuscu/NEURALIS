...
import {
    ArrowLeft, Crown, Gem, Check, Lock, Sparkles,
...
export default function FoxCosmeticsScreen() {
    ...
    const handlePurchase = async (cosmetic: FoxCosmetic) => {
        ...
        if (gems < cosmetic.gemCost) {
            modal.error(i18n.t('fox.not_enough_gems'), `Bu eşya ${cosmetic.gemCost} gem gerektiriyor.\nMevcut: ${gems} gem`);
            return;
        }
                        ...
                        >
                            ...
                            >
                                ...
                                <View style={[
                                    ...
                                    cosmetic.glowColor ? { shadowColor: cosmetic.color, shadowRadius: 12, shadowOpacity: 0.6 } : {},
                                ]}>
                                    <Text style={styles.cosmeticIcon}>{cosmetic.icon}</Text>
                                </View>

                                {/* Name */}
                                <Text style={[styles.cosmeticName, { color: theme.text.primary }]}>{cosmetic.nameTr}</Text>
                                <Text style={[styles.cosmeticDesc, { color: theme.text.secondary }]} numberOfLines={1}>
...
const styles = StyleSheet.create({
    ...
    premiumBtn: { backgroundColor: 'rgba(255, 215, 0, 0.1)', borderWidth: 1, borderColor: 'rgba(255, 215, 0, 0.3)' },
