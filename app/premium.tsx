    ...
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
          ...
          <Animated.View entering={FadeInDown.delay(50)}>
            ...
            >
              ...
              >
                ...
                <Text style={{ fontSize: 22, fontWeight: '900', color: '#FFF', marginTop: 12 }}>
                  7 Gün Ücretsiz Dene!
                </Text>
                <Text
                  style={{
                ...
                >
                  <Text style={{ fontSize: 16, fontWeight: '800', color: '#FFF' }}>
                    {i18n.t('premium_screen.start_free')}
                  </Text>
                </View>
              </LinearGradient>
            </TouchableOpacity>
        ...
        <Animated.View entering={FadeInDown.delay(100)} style={styles.heroSection}>
          <LinearGradient colors={[COLORS.gold, COLORS.goldDark]} style={styles.crownBg}>
            <Crown size={48} color="#FFF" />
          </LinearGradient>
          <Text style={styles.heroTitle}>Upgrade to Premium</Text>
          <Text style={styles.heroSubtitle}>Unlock your full learning potential</Text>
        </Animated.View>
        ...
        <View style={styles.plansSection}>
          ...
          {PLANS.map((plan, index) => (
            <Animated.View key={plan.id} entering={FadeInUp.delay(400 + index * 100)}>
              <TouchableOpacity
                style={[
                  styles.planCard,
        ...
        <Animated.View entering={ZoomIn.delay(700)}>
          ...
          >
            ...
            >
              ...
              <Text style={styles.ctaText}>{purchasing ? 'Processing...' : 'Start Premium'}</Text>
            </LinearGradient>
          </TouchableOpacity>
        </Animated.View>
        ...
        <Text style={styles.terms}>
          Cancel anytime. Subscription auto-renews unless cancelled at least 24 hours before the end
