...
export default function LearningPlanScreen() {
  ...
  const loadPlan = async () => {
    try {
      ...
      setPlan(existing);
      const todayName = [
        i18n.t('learning.days.sun'),
        i18n.t('learning.days.mon'),
        i18n.t('learning.days.tue'),
        i18n.t('learning.days.wed'),
        i18n.t('learning.days.thu'),
        i18n.t('learning.days.fri'),
        i18n.t('learning.days.sat'),
      ][new Date().getDay()];
      ...
      >
        ...
        <Animated.View entering={FadeIn.delay(200)} style={styles.progressSection}>
          ...
          <Text style={styles.progressText}>
            %{completionRate} {i18n.t('learning.completed')} • {plan?.weeklyGoal.totalLessons}{' '}
            {i18n.t('learning.lesson')}
          </Text>
        </Animated.View>
          ...
          return (
            <TouchableOpacity
              ...
              style={[
                ...
                dayCompleted && styles.dayChipDone,
              ]}
            >
            ...
            <Animated.View key={`${selectedDay}_${i}`} entering={FadeInDown.delay(i * 80)}>
              ...
              >
                ...
                <View style={styles.planItemCenter}>
                  ...
                  <Text style={[styles.planReason, { color: theme.text.secondary }]}>
                    {item.reason}
                  </Text>
                  <View style={styles.planMeta}>
                    ...
                    >
                      ...
                      >
                        {item.priority === 'high'
                          ? i18n.t('learning.priority')
                          : item.priority === 'medium'
                            ? i18n.t('learning.normal')
                            : i18n.t('learning.optional')}
                      </Text>
                    </View>
                  </View>
                </View>
