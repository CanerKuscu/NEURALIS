...
export default function SeriesLessonScreen() {
  ...
  const handleNext = () => {
    ...
    if (currentQuestion < lesson.questions.length - 1) {
      ...
      progressWidth.value = withTiming(((currentQuestion + 2) / lesson.questions.length) * 100, {
        duration: 300,
      });
    } else {
      ...
      <View style={[styles.container, { backgroundColor: theme.background.primary }]}>
        ...
        <ScrollView style={styles.overviewContent} contentContainerStyle={{ paddingBottom: 100 }}>
          ...
          <TouchableOpacity
            ...
            onPress={() => {
              setCurrentStep('quiz');
              progressWidth.value = withTiming((1 / Math.max(1, questions.length)) * 100, {
                duration: 300,
              });
            }}
          >
    ...
    <View style={[styles.container, { backgroundColor: theme.background.primary }]}>
            ...
            <View style={styles.optionsContainer}>
              {(currentQ.options || []).map((option: string, idx: number) => {
                ...
                if (showFeedback) {
                  ...
                  optionStyle = [
                    ...optionStyle,
                    { borderColor: theme.primary, borderWidth: 2 } as any,
                  ];
                }
      ...
      {showFeedback && (
        <Animated.View
          ...
          style={[styles.feedbackBar, { backgroundColor: isCorrect ? '#58CC02' : '#FF4B4B' }]}
        >
