...
export default function AudioLessonsScreen() {
              ...
              >
                <View
                  style={[
                    styles.lessonIcon,
                    {
                      backgroundColor: lesson.progress?.isCompleted
                        ? '#2ECC7120'
                        : `${theme.primary}15`,
                    },
                  ]}
                ...
                <View style={{ flex: 1 }}>
                  <Text style={[styles.lessonTitle, { color: theme.text.primary }]}>
                    {lesson.titleTr}
                  </Text>
                  <Text style={[styles.lessonDesc, { color: theme.text.secondary }]}>
                  ...
                  <View style={styles.lessonMeta}>
                    ...
                    >
                      ...
                      >
                        {lesson.level === 'beginner'
                          ? i18n.t('category.beginner')
                          : lesson.level === 'intermediate'
                            ? i18n.t('voice.intermediate')
                            : i18n.t('category.advanced')}
                      </Text>
                    </View>
                  </View>
                </View>
  ...
  if (mode === 'player' && activeLesson) {
    ...
    const progress =
      ((currentSegment + (isPlaying ? 0.5 : 0)) / activeLesson.segments.length) * 100;
      ...
      >
        ...
        <View style={styles.playerBody}>
          ...
          <Animated.View entering={FadeIn.delay(200)} style={styles.visualizer}>
            ...
            {isPlaying && <View style={styles.vizRipple} />}
          </Animated.View>
      ...
      >
        ...
        <View style={{ padding: 24, gap: 16, flex: 1 }}>
          ...
          {q.options.map((opt, i) => (
            <TouchableOpacity
              key={i}
              style={[styles.quizOpt, { backgroundColor: theme.background.secondary }]}
