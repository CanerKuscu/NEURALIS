      ...
      <ScrollView contentContainerStyle={{ padding: 20, gap: 16, paddingBottom: 100 }}>
            ...
            <View style={styles.bannerStats}>
              ...
              <View style={styles.bannerStat}>
                ...
                <Text style={styles.bannerStatText}>
                  {tournament.entryFee} {i18n.t('tournament_screen.entry')}
                </Text>
              </View>
            </View>
        ...
        <View style={styles.prizesRow}>
          {tournament.prizes.map((p, i) => (
            <Animated.View
              ...
              style={[styles.prizeCard, { backgroundColor: theme.background.secondary }]}
            >
            ...
            >
              ...
              <View style={{ flex: 1 }}>
                ...
                <Text style={[styles.lbMeta, { color: theme.text.secondary }]}>
                  {entry.correctAnswers} {i18n.t('tournament_screen.correct')} •{' '}
                  {Math.round(entry.timeSpent)}s
                </Text>
              </View>
        ...
        {leaderboard?.myEntry && (
          <View
            style={[
              styles.lbRow,
              { backgroundColor: '#2ECC7115', borderColor: '#2ECC71', borderWidth: 2 },
            ]}
          >
            ...
            <View style={{ flex: 1 }}>
              ...
              <Text style={[styles.lbMeta, { color: theme.text.secondary }]}>
                {leaderboard.myEntry.correctAnswers} {i18n.t('tournament_screen.correct')} •{' '}
                {Math.round(leaderboard.myEntry.timeSpent)}s
              </Text>
            </View>
