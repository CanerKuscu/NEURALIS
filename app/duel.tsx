      ...
      <View style={styles.content}>
          ...
          <Animated.View entering={FadeInDown} style={styles.lobbyContainer}>
            ...
            <View style={[styles.stakesContainer, { backgroundColor: theme.background.secondary }]}>
              <View style={styles.stakeRow}>
                ...
                <Text style={[styles.stakeText, { color: theme.text.primary }]}>
                  {i18n.t('duel_screen.winner_reward')}
                </Text>
              </View>
              <View style={styles.stakeRow}>
        ...
        {state === 'searching' && (
          <Animated.View entering={FadeIn} style={styles.searchingContainer}>
            ...
            <Text style={[styles.searchingText, { color: theme.text.primary }]}>
              Rakip aranıyor...
            </Text>
          </Animated.View>
        )}
            ...
            <View style={styles.vsContainer}>
              ...
              <View style={styles.playerWrapper}>
                <Image
                  ...
                  style={[styles.opponentAvatar, { backgroundColor: theme.background.tertiary }]}
                />
                <Text style={[styles.playerName, { color: theme.text.primary }]}>
                  {opponent.name}
                </Text>
                <Text style={[styles.playerLevel, { color: theme.text.secondary }]}>
                  Lvl {opponent.level}
                </Text>
              </View>
            </View>
