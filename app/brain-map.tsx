...
import type { BrainMapData, SkillNode, SkillHealth } from '../src/services/BrainMapService';
import { brainMapService } from '../src/services/BrainMapService';
      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 120 }}>
        ...
        <View style={styles.mapContainer}>
          <Svg width={mapSize} height={mapSize}>
            ...
            {/* Center brain node */}
            <Circle cx={centerX} cy={centerY} r={28} fill="#6C5CE7" stroke="#FFF" strokeWidth={3} />
            <SvgText x={centerX} y={centerY + 5} fontSize="22" fill="#FFF" textAnchor="middle">
              🧠
            </SvgText>
        ...
        <View style={styles.skillList}>
          ...
          {[...(brainMap?.skills || [])]
            ...
            .map((skill, idx) => (
              <Animated.View key={skill.skillId} entering={FadeInDown.delay(idx * 60)}>
                <TouchableOpacity
                ...
                >
                  <View
                    style={[
                      styles.skillColorBar,
                      { backgroundColor: skill.color, opacity: skill.opacity },
                    ]}
                  />
                  <View style={styles.skillInfo}>
                    <Text style={[styles.skillName, { color: theme.text.primary }]}>
                      {skill.nameTr}
                    </Text>
                    <View style={styles.skillMeta}>
                      <View
                        style={[
                          styles.healthBadge,
                          { backgroundColor: `${HEALTH_COLORS[skill.healthState]}20` },
                        ]}
                      >
                        <View
                          style={[
                        ...
                        />
                        <Text
                          style={[styles.healthText, { color: HEALTH_COLORS[skill.healthState] }]}
                        >
                  ...
                  {(skill.healthState === 'decaying' ||
                    skill.healthState === 'dead' ||
                    skill.healthState === 'fading') && (
                ...
                .map((skill, idx) => (
                  <Animated.View key={skill.skillId} entering={FadeIn.delay(idx * 50)}>
                    ...
                    >
                      ...
                      <Text style={[styles.untriedName, { color: theme.text.secondary }]}>
                        {skill.nameTr}
                      </Text>
