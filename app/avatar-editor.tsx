...
const CATEGORIES = [
    { key: 'face', label: 'Face', icon: '😊', color: '#FFB74D', subCategories: ['skinColor', 'eyeType', 'eyeColor', 'mouthType'] },
    { key: 'hair', label: 'Hair', icon: '💇', color: '#BA68C8', subCategories: ['hairType', 'hairColor'] },
    { key: 'accessories', label: 'Style', icon: '✨', color: '#4FC3F7', subCategories: ['glassesType', 'glassesColor', 'hatType', 'hatColor', 'facialHairType'] },
    { key: 'outfit', label: 'Outfit', icon: '👕', color: '#81C784', subCategories: ['shirtType', 'shirtColor'] },
...
export default function AvatarEditor() {
    ...
    const isColorPicker = currentSubCategoryKey.includes('Color') || currentSubCategoryKey === 'bgColor';
        ...
        <View style={[styles.container, { paddingTop: insets.top }]}>
            ...
            <View style={styles.selectionHeader}>
                <Text style={styles.selectionLabel}>
                    {SUB_CATEGORY_LABELS[currentSubCategoryKey]}
                </Text>
                        ...
                        <View style={styles.colorGrid}>
                            {currentOptions.map((color, index) => (
                                <ColorSwatch
                                    ...
                                    onPress={() => updateConfig(currentSubCategoryKey as keyof AvatarConfig, color as string)}
                                    delay={index * 30}
                                />
                            ))}
                        </View>
                        ...
                        <View style={styles.optionsGrid}>
                            {currentOptions.map((option, index) => (
                                <OptionCard
                                    ...
                                    onPress={() => updateConfig(currentSubCategoryKey as keyof AvatarConfig, option as string)}
                                    delay={index * 50}
                                />
                            ))}
                        </View>
