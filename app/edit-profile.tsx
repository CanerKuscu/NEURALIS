            ...
            {loading ? (
                ...
                <ScrollView contentContainerStyle={styles.content}>
                    ...
                    <View style={styles.inputGroup}>
                        ...
                        <View style={[styles.inputWrapper, { backgroundColor: theme.background.secondary, borderColor: theme.border.light }]}>
                    ...
                    <View style={styles.inputGroup}>
                        ...
                        <View style={[styles.inputWrapper, { backgroundColor: theme.background.tertiary, borderColor: theme.border.light }]}>
                    ...
                    <View style={styles.inputGroup}>
                        ...
                        <TouchableOpacity
                            ...
                            style={[styles.inputWrapper, { backgroundColor: theme.background.secondary, borderColor: theme.border.light }]}
                        >
...
const styles = StyleSheet.create({
    ...
    inputWrapper: {
        ...
        paddingHorizontal: 16, height: 56, borderRadius: RADIUS.input,
    ...
    saveBtn: {
        ...
        height: 56, borderRadius: RADIUS.button, gap: 10,
        marginTop: 20,
