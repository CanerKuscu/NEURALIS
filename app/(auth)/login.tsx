        ...
        <View style={styles.container}>
            ...
            <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined} style={{ flex: 1 }}>
                ...
                <View style={[styles.header, { paddingTop: insets.top + 20 }]}>
                    ...
                    <Animated.Text entering={FadeInUp.delay(300)} style={styles.welcomeText}>{i18n.t('auth.welcome_back')}</Animated.Text>
                    <Animated.Text entering={FadeInUp.delay(400)} style={styles.subText}>{i18n.t('auth.continue_streak')}</Animated.Text>
                </View>
                ...
                <Animated.View entering={FadeInDown.springify().delay(200)} style={styles.formCard}>
                    ...
                    <View style={styles.inputContainer}>
                        ...
                        <TouchableOpacity onPress={() => router.push('/(auth)/forgot-password')} style={{ alignSelf: 'flex-end', marginTop: 12 }}>
                            <Text style={styles.forgotText}>{i18n.t('auth.forgot_password')}</Text>
                        </TouchableOpacity>
                    </View>

                    <TouchableOpacity onPress={handleLogin} disabled={loading} style={styles.loginBtn} accessibilityRole="button" accessibilityLabel={i18n.t('auth.login_btn')}>
                        <LinearGradient
...
const styles = StyleSheet.create({
    ...
    mascotContainer: {
        marginBottom: 10,
        shadowColor: "#2ECC71", shadowOffset: { width: 0, height: 10 }, shadowOpacity: 0.2, shadowRadius: 20, elevation: 10
    },
    ...
    loginBtn: { marginTop: 8, borderRadius: 20, overflow: 'hidden', elevation: 6, shadowColor: '#2ECC71', shadowOpacity: 0.4, shadowRadius: 10, shadowOffset: { width: 0, height: 6 } },
