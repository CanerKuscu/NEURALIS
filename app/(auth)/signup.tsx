...
import { Mail, Lock, ArrowRight, User, ChevronLeft, CheckCircle, Eye, EyeOff, Calendar } from 'lucide-react-native';
...
export default function SignupScreen() {
    ...
    return (
        <View style={styles.container}>
            <LinearGradient colors={['#E0F7FA', '#FFF', '#E8F5E9']} style={StyleSheet.absoluteFill} start={{ x: 0, y: 0 }} end={{ x: 1, y: 1 }} />
            ...
            <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined} style={{ flex: 1 }}>
                <ScrollView contentContainerStyle={{ paddingBottom: 40 + insets.bottom }} showsVerticalScrollIndicator={false}>
                    ...
                    <Animated.View entering={FadeInDown.springify().delay(200)} style={styles.formCard}>
                        ...
                        <View style={styles.inputContainer}>
                            ...
                            <TouchableOpacity onPress={() => setShowDatePicker(true)} activeOpacity={0.7}>
                                <View style={[styles.inputWrapper, errors.birthDate && styles.errorBorder]}>
                                    ...
                                    <Text style={[styles.input, { paddingVertical: 18, color: birthDate ? '#2C3E50' : '#BDC3C7' }]}>
                            ...
                            {Platform.OS === 'ios' && showDatePicker && (
                                <View style={{ flexDirection: 'row', justifyContent: 'flex-end', marginTop: 8 }}>
                                    <TouchableOpacity
                                        ...
                                        style={{ backgroundColor: '#2ECC71', paddingHorizontal: 16, paddingVertical: 8, borderRadius: 8 }}
                                    >
                        ...
                        <Text style={{ color: '#888', fontSize: 12, textAlign: 'center', marginTop: 12, lineHeight: 18 }}>
                            {i18n.t('auth.terms_agreement')}{' '}
                            <Text style={{ color: '#2ECC71', textDecorationLine: 'underline' }} onPress={() => router.push('/legal?tab=terms')}>
                                {i18n.t('auth.terms_of_service')}
                            </Text>
                            {' '}{i18n.t('auth.and')}{' '}
                            <Text style={{ color: '#2ECC71', textDecorationLine: 'underline' }} onPress={() => router.push('/legal?tab=privacy')}>
...
const styles = StyleSheet.create({
    ...
    welcomeText: { fontSize: 32, fontWeight: '900', color: '#2C3E50', marginBottom: 8, letterSpacing: 0.5 },
    ...
    errorBanner: {
        backgroundColor: '#FDECEA', borderRadius: 12, padding: 12, marginBottom: 16, borderWidth: 1, borderColor: '#F5B7B1'
    },
    errorBannerText: { color: '#E74C3C', fontWeight: '600', fontSize: 14, textAlign: 'center' },

    inputContainer: { marginBottom: 16 },
    label: { fontSize: 14, fontWeight: '800', color: '#2C3E50', marginBottom: 8, marginLeft: 4, textTransform: 'uppercase', letterSpacing: 0.5 },
    inputWrapper: {
        flexDirection: 'row', alignItems: 'center',
        backgroundColor: '#F7F7F7',
        borderRadius: 16,
        height: 60, paddingHorizontal: 16,
        borderWidth: 2, borderColor: '#F0F0F0', gap: 12
    },
    errorBorder: {
        borderColor: '#E74C3C', backgroundColor: '#FEF9E7'
    },
    ...
    loginBtn: { marginTop: 10, borderRadius: 20, overflow: 'hidden', elevation: 6, shadowColor: '#2ECC71', shadowOpacity: 0.4, shadowRadius: 10, shadowOffset: { width: 0, height: 6 } },
    gradientBtn: { paddingVertical: 18, flexDirection: 'row', justifyContent: 'center', alignItems: 'center', gap: 8 },
