...
export default function ForgotPasswordScreen() {
    ...
    return (
        <View style={styles.container}>
            <LinearGradient colors={['#FFF', '#E8F5E9']} style={StyleSheet.absoluteFill} start={{ x: 0, y: 0 }} end={{ x: 1, y: 1 }} />
            ...
            <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined} style={{ flex: 1 }}>
                ...
                <View style={[styles.content, { paddingBottom: insets.bottom + 20 }]}>
                    <Animated.View entering={FadeInUp.delay(200).springify()} style={[styles.iconContainer, { backgroundColor: '#E8F5E9', borderRadius: 50, padding: 20 }]}>
                        <Lock size={60} color="#2ECC71" strokeWidth={2.5} />
                    </Animated.View>

                    <Animated.Text entering={FadeInUp.delay(300)} style={styles.title}>Forgot Password?</Animated.Text>
...
const styles = StyleSheet.create({
    ...
    iconContainer: {
        marginBottom: 24,
        shadowColor: "#2ECC71", shadowOffset: { width: 0, height: 10 }, shadowOpacity: 0.2, shadowRadius: 20, elevation: 5
    },
    lockIcon: { width: 100, height: 100 },

    title: { fontSize: 28, fontWeight: '900', color: '#2C3E50', marginBottom: 12, letterSpacing: 0.5 },
    subtitle: { fontSize: 16, color: '#7F8C8D', textAlign: 'center', marginBottom: 40, paddingHorizontal: 20, lineHeight: 24 },
    ...
    resetBtn: { marginTop: 10, borderRadius: 20, overflow: 'hidden', elevation: 6, shadowColor: '#2ECC71', shadowOpacity: 0.4, shadowRadius: 10, shadowOffset: { width: 0, height: 6 } },
