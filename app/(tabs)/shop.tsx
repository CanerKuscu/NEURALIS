...
const ITEMS: ShopItem[] = [
  {
    id: 'freeze',
    nameKey: 'shop.streak_freeze',
    descKey: 'shop.streak_freeze_desc',
    price: 200,
    icon: Shield,
    color: '#3498DB',
  ...
  {
    id: 'refill',
    nameKey: 'shop.heart_refill',
    descKey: 'shop.heart_refill_desc',
    price: 350,
    icon: Heart,
    color: '#FF4B4B',
    gradient: ['#FF4B4B', '#C0392B'],
  },
  {
    id: 'boost',
    nameKey: 'shop.xp_boost',
    descKey: 'shop.xp_boost_desc',
    price: 150,
    icon: Zap,
    color: '#F1C40F',
...
export default function ShopScreen() {
  ...
  const [purchaseModal, setPurchaseModal] = useState<{ visible: boolean; item?: ShopItem | null }>({
    visible: false,
    item: null,
  });
    ...
    modal.confirm(
      ...
      async () => {
        ...
        if (session) {
          ...
          modal.success(
            i18n.t('shop.success'),
            i18n.t('shop.purchase_success', { amount: pack.amount }),
          );
        }
      },
      i18n.t('shop.buy'),
    ...
    >
      ...
      {loading ? (
        ...
        >
            ...
            {GEM_PACKS.map((pack) => (
              ...
              >
                ...
                >
                  ...
                  <Text style={[styles.packAmount, { color: theme.text.primary }]}>
                    {pack.amount}
                  </Text>
                  <Text style={[styles.packPrice, { color: theme.text.secondary }]}>
                    {pack.price}
                  </Text>
                </View>
              </TouchableOpacity>
          ...
          {/* Cosmetics Section */}
          <Text style={[styles.sectionTitle, { color: theme.text.primary }]}>
            {i18n.t('shop.cosmetics')}
          </Text>
          {[
            {
              id: 'aura_fire',
              nameKey: 'shop.cosmetic_fire_aura',
              descKey: 'shop.cosmetic_fire_aura_desc',
              price: 500,
              icon: Sparkles,
              color: '#FF6B6B',
              gradient: ['#FF6B6B', '#E74C3C'] as [string, string],
            },
            {
              id: 'hat_wizard',
              nameKey: 'shop.cosmetic_wizard_hat',
              descKey: 'shop.cosmetic_wizard_hat_desc',
              price: 300,
              icon: Crown,
              color: '#9B59B6',
            ...
            {
              id: 'theme_neon',
              nameKey: 'shop.cosmetic_neon_theme',
              descKey: 'shop.cosmetic_neon_theme_desc',
              price: 800,
              icon: Palette,
              color: '#00CEC9',
              gradient: ['#00CEC9', '#0984E3'] as [string, string],
            },
            {
              id: 'outfit_gold',
              nameKey: 'shop.cosmetic_gold_cape',
              descKey: 'shop.cosmetic_gold_cape_desc',
              price: 1200,
              icon: Shirt,
              color: '#F1C40F',
            ...
            >
                      ...
                      if (session) {
                        ...
                        setPurchaseModal({
                          ...
                          item: {
                            ...
                            descKey: cosmetic.descKey,
                            price: cosmetic.price,
                            icon: cosmetic.icon,
                            color: cosmetic.color,
                            gradient: cosmetic.gradient,
                          },
                        });
                        setTimeout(() => setPurchaseModal({ visible: false, item: null }), 2500);
                      }
              ...
              >
                <View
                  style={[styles.cardShadow, { backgroundColor: cosmetic.color, opacity: 0.3 }]}
                />
                <View
                  style={[
                    styles.cardContent,
                ...
                >
                  ...
                  <View style={styles.textContainer}>
                    <Text style={[styles.itemName, { color: theme.text.primary }]}>
                      {i18n.t(cosmetic.nameKey)}
                    </Text>
                    <Text style={[styles.itemDesc, { color: theme.text.secondary }]}>
                      {i18n.t(cosmetic.descKey)}
                    </Text>
                  </View>
                  <View style={styles.priceContainer}>
          ...
          <Animated.View entering={ZoomIn.springify()} exiting={ZoomOut} style={styles.modalCard}>
            <LinearGradient colors={[COLORS.primary, '#27AE60']} style={styles.modalGradient}>
              ...
              <Text style={styles.modalText}>
                {purchaseModal.item
                  ? i18n.t('shop.item_added', { item: i18n.t(purchaseModal.item.nameKey) })
                  : ''}
              </Text>
            </LinearGradient>
          </Animated.View>
