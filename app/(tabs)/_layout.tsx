        ...
        <Tabs
            ...
            <Tabs.Screen
                ...
                options={{
                    ...
                    tabBarIcon: ({ color, focused }) => (
                        <Home size={24} color={color} fill={focused ? color : 'transparent'} strokeWidth={2.5} />
                    ),
                }}
            />
            <Tabs.Screen
                ...
                options={{
                    ...
                    tabBarIcon: ({ color, focused }) => (
                        <View>
                            <Gem size={24} color={color} fill={focused ? color : 'transparent'} strokeWidth={2.5} />
                        </View>
                    ),
                }}
            />
            ...
            <Tabs.Screen
                ...
                options={{
                    ...
                    tabBarIcon: ({ color, focused }) => (
                        <Trophy size={24} color={focused ? COLORS.ruby : color} fill={focused ? COLORS.ruby : 'transparent'} strokeWidth={2.5} />
                    ),
                }}
            />
            <Tabs.Screen
