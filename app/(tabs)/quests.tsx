...
export default function QuestsScreen() {
  ...
  const loadProfile = async () => {
    ...
    if (session) {
      ...
      const now = new Date();
      const monthKeys = [
        'quests.months.january',
        'quests.months.february',
        'quests.months.march',
        'quests.months.april',
        'quests.months.may',
        'quests.months.june',
        'quests.months.july',
        'quests.months.august',
        'quests.months.september',
        'quests.months.october',
        'quests.months.november',
        'quests.months.december',
      ];
      setMonthlyChallenge({
  ...
  return (
    ...
    >
      ...
      <View style={[styles.header, { backgroundColor: theme.background.secondary }]}>
        ...
        <TouchableOpacity
          style={[styles.historyBtn, { backgroundColor: isDark ? '#2D4A3E' : '#E8F5E9' }]}
        >
      ...
      >
              ...
              <View style={styles.monthlyHeader}>
                <View>
                  <Text style={styles.monthlyLabel}>
                    {monthlyChallenge.monthName.toUpperCase()} {i18n.t('quests.challenge')}
                  </Text>
                ...
                <View style={{ flex: 1 }}>
                  <View style={styles.monthlyTrack}>
                    <View
                      style={[
                        styles.monthlyBar,
                        { width: `${(monthlyChallenge.current / monthlyChallenge.target) * 100}%` },
                      ]}
                    />
                  </View>
                  <Text style={styles.monthlyStats}>
                    {monthlyChallenge.current} / {monthlyChallenge.target}{' '}
                    {i18n.t('quests.completed')}
                  </Text>
                </View>
            ...
            >
              ...
              <View style={{ flex: 1 }}>
                ...
                >
                  ...
                  <Text style={[styles.questXp, quest.completed && { color: '#2ECC71' }]}>
                    {quest.completed ? '✓' : `+${quest.xp} XP`}
                  </Text>
                </View>
                <Text style={[styles.questDesc, { color: theme.text.secondary }]}>
                  {quest.desc}
                </Text>
                <ProgressBar
        ...
        >
          ...
          <View style={{ flex: 1 }}>
            <Text style={[styles.questTitle, { color: theme.text.primary }]}>
              {i18n.t('quests.mystery_quest')}
            </Text>
            <Text style={[styles.questDesc, { color: theme.text.secondary }]}>
              {i18n.t('quests.mystery_quest_desc')}
            </Text>
          </View>
        </View>
      </ScrollView>
