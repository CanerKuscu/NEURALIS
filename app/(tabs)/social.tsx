  ...
  return (
    ...
    >
      ...
      >
        ...
        <TouchableOpacity
          style={[styles.addBtn, { backgroundColor: isDark ? '#2D4A3E' : '#E8F5E9' }]}
        >
        ...
        >
          ...
          <View style={styles.sectionHeader}>
            <Text style={[styles.sectionTitle, { color: theme.text.primary }]}>
              {i18n.t('social.suggested_for_you')}
            </Text>
          </View>
              ...
              renderItem={({ item, index }) => (
                <Animated.View entering={FadeInRight.delay(index * 100).springify()}>
                  ...
                  >
                    ...
                    <Text
                      style={[styles.suggestName, { color: theme.text.primary }]}
                      numberOfLines={1}
                    >
                      {item.display_name || i18n.t('social.default_name')}
                    </Text>
                    <Text style={[styles.suggestLang, { color: theme.text.secondary }]}>
                    ...
                    <TouchableOpacity
                      style={[
                        ...
                        followedIds.has(item.id) && styles.followedBtn,
                      ]}
          ...
          <View style={styles.sectionHeader}>
            <Text style={[styles.sectionTitle, { color: theme.text.primary }]}>
              {i18n.t('social.community_activity')}
            </Text>
          </View>
                ...
                >
                  ...
                  <View style={{ flex: 1 }}>
                    <View style={{ flexDirection: 'row', alignItems: 'center', gap: 6 }}>
                      <Text style={[styles.feedUser, { color: theme.text.primary }]}>
                        {item.user_name}
                      </Text>
                      <Text style={[styles.feedTime, { color: theme.text.muted }]}>
                        • {formatTimeAgo(item.created_at)}
                      </Text>
                    </View>
                    <Text style={[styles.feedAction, { color: theme.text.secondary }]}>
                      {item.action}
                    </Text>
                  </View>
                  <TouchableOpacity>
