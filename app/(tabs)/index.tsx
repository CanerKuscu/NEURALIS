...
export default function HomeScreen() {
  ...
  const loadProfile = async (force = false) => {
    ...
    try {
      ...
      const { data, error } = await supabase
        .from('profiles')
        .select(
          'username, display_name, first_name, last_name, current_streak, total_xp, current_lives, is_premium',
        )
  ...
  const userName =
    (profile?.first_name || profile?.display_name || profile?.username || fallbackName).trim() ||
    fallbackName;
  ...
  return (
    <View
      style={[
        styles.container,
        { paddingTop: insets.top + 10, backgroundColor: theme.background.primary },
      ]}
    >
      <StatusBar
      ...
      <View style={styles.header}>
        <View style={styles.headerLeft}>
          ...
          <Text style={[styles.subGreeting, { color: theme.text.secondary }]}>
            {getMotivation()}
          </Text>
        </View>
        ...
        <View style={styles.statsRow}>
          <TouchableOpacity
            style={[styles.statBadge, { backgroundColor: theme.background.secondary }]}
            activeOpacity={0.8}
          >
      ...
      >
        ...
        <Animated.View entering={FadeInDown.delay(100).springify()}>
          <TouchableOpacity
            ...
            onPress={() => handleSubjectPress(CATEGORY_TREE[0])}
          >
            <LinearGradient
            ...
            <View style={[styles.dailyStatusCard, { backgroundColor: theme.background.secondary }]}>
              <View style={styles.dailyStatusLeft}>
                ...
                <Text style={[styles.dailyStatusText, { color: theme.text.primary }]}>
                  Günlük Ders: {dailyData.lessonsCompletedToday}/
                  {dailyData.lessonsCompletedToday + dailyData.remainingLessons}
                </Text>
              </View>
        ...
        {/* LEAGUE TEASER */}
        <TouchableOpacity
          style={[styles.leagueTeaser, { backgroundColor: theme.background.secondary }]}
        ...
        >
          ...
          <View style={{ flex: 1 }}>
            ...
            <Text style={[styles.leagueSub, { color: theme.text.secondary }]}>
              Diğerleriyle yarış!
            </Text>
          </View>
        ...
        <View style={styles.featureGrid}>
          ...
          <TouchableOpacity
            activeOpacity={0.8}
            style={styles.featureCard}
            onPress={() => router.push('/quick-fire')}
          >
          ...
          <TouchableOpacity
            activeOpacity={0.8}
            style={styles.featureCard}
            onPress={() => router.push('/study-rooms')}
          >
            <LinearGradient colors={['#00B894', '#00CEC9']} style={styles.featureGradient}>
          ...
          <TouchableOpacity
            activeOpacity={0.8}
            style={styles.featureCard}
            onPress={() => router.push('/exam-simulator')}
          >
        ...
        <View style={styles.featureGrid}>
          ...
          <TouchableOpacity
            activeOpacity={0.8}
            style={styles.featureCard}
            onPress={() => router.push('/flashcard-creator')}
          >
            <LinearGradient colors={['#6C5CE7', '#A29BFE']} style={styles.featureGradient}>
          ...
          <TouchableOpacity
            activeOpacity={0.8}
            style={styles.featureCard}
            onPress={() => router.push('/wall-of-fame')}
          >
        ...
        <View style={styles.featureGrid}>
          ...
          <TouchableOpacity
            activeOpacity={0.8}
            style={styles.featureCard}
            onPress={() => router.push('/streak-recovery')}
          >
          ...
          <TouchableOpacity
            activeOpacity={0.8}
            style={styles.featureCard}
            onPress={() => router.push('/topic-leaderboard')}
          >
            <LinearGradient colors={['#1ABC9C', '#16A085']} style={styles.featureGradient}>
          ...
          <TouchableOpacity
            activeOpacity={0.8}
            style={styles.featureCard}
            onPress={() => router.push('/community-marketplace')}
          >
            <LinearGradient colors={['#FF9600', '#FDCB6E']} style={styles.featureGradient}>
