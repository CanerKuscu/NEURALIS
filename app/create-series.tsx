...
export default function CreateSeriesScreen() {
    ...
    }, [topic, selectedCategory, selectedDifficulty, lessonCount, customInstructions, isPublic, hasPremium]);
    ...
    return (
        <View style={[styles.container, { backgroundColor: theme.background.primary, paddingTop: insets.top }]}>
            ...
            <View style={styles.header}>
                ...
                <Text style={[styles.headerTitle, { color: theme.text.primary }]}>Create Lesson Series</Text>
                <View style={{ width: 40 }} />
            </View>
            ...
            >
                        ...
                        {LESSON_CATEGORIES.map((cat) => (
                            <TouchableOpacity
                                ...
                                style={[
                                    styles.categoryChip,
                                    {
                                        backgroundColor: selectedCategory === cat.id ? cat.color : theme.background.secondary,
                        ...
                        {DIFFICULTY_LEVELS.map((level) => (
                            <TouchableOpacity
                                ...
                                style={[
                                    ...
                                    {
                                        backgroundColor: theme.background.secondary,
                                        borderColor: selectedDifficulty === level.id ? theme.primary : theme.border.light,
                        ...
                        {LESSON_COUNTS.map((count) => (
                            <TouchableOpacity
                                ...
                                style={[
                                    styles.countBtn,
                                    {
                                        backgroundColor: lessonCount === count ? theme.primary : theme.background.secondary,
                ...
                {/* Generate Button */}
                <Animated.View entering={FadeInDown.delay(600).duration(500)} style={styles.generateSection}>
                    {isGenerating ? (
